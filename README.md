...
```bash
# 前端 44 用例（5 个文件，node:test + jsdom）
...
`docs/`：01-PRD / 02-架构设计 / 03-UI设计规范 / 04-测试方案 / 05-接口规范 / 06-项目计划 / 07-决策问答记录 / **08-策略与架构评审报告** / **09-改造实施方案** / **10-改造方案自审与优化建议** / **11-组合风控实盘落地指南**
...
- 当前版本：**v0.4.0**（应用内版本号见 `static/index.html`，形如 `V0.4.0 · 2026-09-11`）
- 发布标签：`v0.4.0`（含本地量价面板与 UI、策略/架构评审 08~11、组合风控工具、配置与接口完善）
